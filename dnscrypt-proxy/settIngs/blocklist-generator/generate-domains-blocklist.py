...
# facebook.com @work
"""
    print(header, file=output_fd, end="")
...
def main():
    ...
    argp.add_argument(
        "-a",
        "--allowlist",
        default="~/dotfiles/dnscrypt-proxy/settings/allowed-domains.txt",
        help="file containing a set of names to exclude from the blocklist",
    )
    argp.add_argument(
        "-r",
        "--time-restricted",
        default="~/dotfiles/dnscrypt-proxy/settings/blocked-time-periods.txt",
    ...
    argp.add_argument(
        "-o",
        "--output-file",
        default="~/dotfiles/dnscrypt-proxy/settings/blocked-domains-generated.txt",
    ...
    if args.allowlist:
        args.allowlist = os.path.expanduser(args.allowlist)
    if args.time_restricted:
        args.time_restricted = os.path.expanduser(args.time_restricted)
    if args.config:
